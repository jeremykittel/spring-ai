...
const generateImageStyles = (icon: string) => {
    const url = `url('line-awesome/svg/${icon}.svg')`;
    return {
        '--maskImage': url,
        'maskImage': 'var(--maskImage)',
        'WebkitMaskImage': 'var(--maskImage)'
    } as any
}
...
export default function MenuOnLeftLayout() {
    ...
    return (
        <AppLayout className="block h-full" primarySection="drawer">
            <header slot="drawer">
                <h1 className="text-l m-0">Jeremy Kittel</h1>
            </header>
            <Scroller slot="drawer" scroll-direction="vertical">
                <nav>
                  ...
                  <span
                      ...
                      style={generateImageStyles(icon)}
                      aria-hidden="true"
                  ></span>
                                    {title}
                                </Item>
